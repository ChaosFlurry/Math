...
/****
 * 
 * @author ChaosFlurry TODO important to implement simplify() in MathUtil.
 */

public class SingleRadical extends RadicalContainer {
	int coefficient;
	int radicand;
	int index;
	//boolean undefined;
	...
	public SingleRadical(int radicand, int index) {
	...
	public SingleRadical(int coefficient, int radicand, int index) {
		this.coefficient = coefficient;
		this.radicand = radicand;
		this.index = index;
	}

	public SingleRadical(int radicand, Fraction index) {
		this.coefficient = 1;
		this.radicand = (int) (Math.pow(radicand, index.getNumerator()));
		this.index = index.getDenominator();
	}

	public SingleRadical(int coefficient, int radicand, Fraction index) {
		this.coefficient = coefficient;
		this.radicand = (int) (Math.pow(radicand, index.getNumerator()));
		this.index = index.getDenominator();
	}
